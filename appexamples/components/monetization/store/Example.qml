...
App {
  ...
  property string creditsCurrencyItemId: "net.felgo.demos.PluginDemo.credits"
  property string creditsPackItemId: "net.felgo.demos.PluginDemo.creditspack"
  property string goodieItemId: "net.felgo.demos.PluginDemo.goodie"
  property string noAdsItemId: "net.felgo.demos.PluginDemo.noads"
  ...
  NavigationStack {
    ListPage {
      ...
      Store {
        ...
        goods: [
          // A goodie costs 3 credits (virtual currency that can be purchased with an in-app purchase)
          SingleUseGood {
            id: goodieGood
            itemId: goodieItemId
            name: "Goodie"
