  ...
  NavigationStack {
    AppPage {
      ...
      AppCard {
        ...
        header: SimpleRow {
          imageSource: "https://raw.githubusercontent.com/FelgoSDK/Demos-Examples/master/preview-assets/appexamples/components/appcard/architecture-1477041_960_720.jpg"
          text: "Lorem ipsum"
