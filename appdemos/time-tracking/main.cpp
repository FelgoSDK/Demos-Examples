...
// Uncomment this line to add Felgo Hot Reload and use use reloading with your custom C++ code
...
int main(int argc, char *argv[])
{
  ...
  felgo.setMainQmlFileName(QStringLiteral("qml/TimeTrackingMain.qml"));
  ...
  // felgo.setMainQmlFileName(QStringLiteral("qrc:/qml/TimeTrackingMain.qml"));
