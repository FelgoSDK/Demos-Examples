...
Item {
  ...
  Connections {
    ...
    function onSearchListings(searchText, addToRecents) {
    ...
    function onToggleFavorite(listingData) {
  ...
  PositionSource {
    ...
    onSourceErrorChanged: if(sourceError === PositionSource.UpdateTimeoutError) console.log("location timed out")
  }
