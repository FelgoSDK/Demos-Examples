...
AppPage {
  ...
  Column {
    anchors {
      ...
      top: parent.top
      topMargin: nativeUtils.safeAreaInsets.top + dp(10)
    }
    spacing: dp(10)
  ...
  Grid {
    ...
    anchors {
      ...
      bottomMargin: dp(10) + nativeUtils.safeAreaInsets.bottom
    }
    columns: 5

    Repeater {
      model: [
        { day: Qt.locale().dayName(0, Locale.ShortFormat), high: 34, low: 24, iconType: IconType.suno },
        { day: Qt.locale().dayName(1, Locale.ShortFormat), high: 32, low: 20, iconType: IconType.suno },
        { day: Qt.locale().dayName(2, Locale.ShortFormat), high: 33, low: 20, iconType: IconType.suno },
        { day: Qt.locale().dayName(3, Locale.ShortFormat), high: 28, low: 21, iconType: IconType.suno },
        { day: Qt.locale().dayName(4, Locale.ShortFormat), high: 24, low: 16, iconType: IconType.suno }
      ]
