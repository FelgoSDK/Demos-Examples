      ...
      GridSection {
        ...
        SectionItem {
          ...
          FloatingActionButton {
            ...
            onClicked: {
              icon === IconType.star ? icon = IconType.envelope : icon = IconType.star
            }
          }
        }
      ...
      GridSection {
        ...
        SectionItem {
          ...
          AppButton {
            ...
            Quick2.ToolTip.visible: pressed
            Quick2.ToolTip.delay: Qt.styleHints.mousePressAndHoldInterval
            Quick2.ToolTip.text: "A simple ToolTip"
            text: "Press and Hold"
          }
        }
      ...
      Section {
        ...
        SectionItem {
          ...
          Quick2.SwipeView {
            ...
            width: (parent.width - dp(30)) > dp(400) ? dp(400) : parent.width - dp(30)
            height: width / 1.5
      ...
      Section {
        ...
        Grid {
          ...
          AppButton {
            ...
            flat: false
            onClicked: {
              nativeUtils.displayCameraPicker(qsTr("Title"))
            }
          }
      ...
      Section {
        ...
        Row {
          ...
          Column {
            ...
            AppText {
              text: "<b>Device Online:</b> " + system.isOnline
              font.pixelSize: sp(11)
            }
            AppText {
          ...
          Column {
            ...
            AppText {
              text: "<b>Felgo Version:</b> " + system.vplayVersion
              font.pixelSize: sp(11)
            }
          }
        }
