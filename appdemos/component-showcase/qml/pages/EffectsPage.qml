  ...
  Item {
    ...
    AppFlickable {
      ...
      Column  {
        ...
        Section {
          ...
          Rectangle {
            ...
            Video {
              ...
              source: "https://felgo.com/resources/HotReloadProductVideo_1080p.mp4"
              //autoLoad: true
        ...
        // Blend effect currently not implemented in Qt 6
        ...
        Section {
          ...
          Row {
            ...
            CustomComboBox {
              ...
              // Qt 6 - RadialBlur currently not supported
...
//            }
  ...
  Column {
    ...
    spacing: dp(20)
    opacity: 0.5
    visible: fxControls.currentEffectName === "Genie"
    width: parent.width
  ...
  VideoFXEffect {
    ...
    onEffectLoaded: effectItem => {
      fxControls.parameterPanel.model = effectItem.parameters
    }
  }
  ...
  VideoFXControls {
    ...
    function show() {
      ...
      fxControls.loadEffect("Wobble", "effects/EffectWobble.qml")
    }

    function hide() {
      fxControls.visible = false
      fxControls.loadEffect("No effect", "effects/EffectPassThrough.qml")
    }
  }
}
